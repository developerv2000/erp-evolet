@canany(['view-PLPD-ready-for-order-processes', 'view-PLPD-orders', 'view-PLPD-order-products', 'view-PLPD-invoices'])
    <div class="leftbar__section leftbar__section--PLPD">
        ...
        <nav class="leftbar__nav">
            ...
            {{-- Invoices --}}
            @can('view-PLPD-invoices')
                <a
                    @class([
                        'leftbar__nav-link',
                        'leftbar__nav-link--active' => request()->routeIs('plpd.invoices.index'),
                    ])
                    href="{{ route('plpd.invoices.index') }}">
