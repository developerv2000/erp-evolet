@extends('layouts.app', [
    ...
    'pageName' => 'warehouse-products-index',
...
@section('content')
    <div class="main-box styled-box">
        ...
        {{-- Table --}}
        @include('warehouse.products.table.layout', ['trashedRecords' => false])
    </div>

    {{-- Modals --}}
    <x-modals.edit-table-columns
        form-action="{{ route('settings.update-table-columns', 'warehouse_order_products_table_columns') }}"
