<x-tables.template.main-template class="prd-orders-table" :records="$records">
    {{-- thead titles --}}
    <x-slot:thead-rows>
        <tr>
            ...
            @foreach ($visibleTableColumns as $column)
                <th width="{{ $column['width'] }}">
                    @include('PRD.orders.table.thead-columns')
                </th>
            @endforeach
        </tr>
    </x-slot:thead-rows>
    ...
    <x-slot:tbody-rows>
        @foreach ($records as $record)
            <tr>
                ...
                @foreach ($visibleTableColumns as $column)
                    <td>
                        @include('PRD.orders.table.tbody-row-columns')
                    </td>
                @endforeach
            </tr>
        @endforeach
