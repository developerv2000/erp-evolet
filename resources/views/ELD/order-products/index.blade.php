@extends('layouts.app', [
    ...
    'pageName' => 'eld-order-products-index',
...
@section('content')
    <div class="main-box styled-box">
        ...
        {{-- Table --}}
        @include('ELD.order-products.table.layout', ['trashedRecords' => false])
    </div>

    {{-- Modals --}}
    <x-modals.edit-table-columns
        form-action="{{ route('settings.update-table-columns', 'ELD_order_products_table_columns') }}"
