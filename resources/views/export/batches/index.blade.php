...
@section('content')
    <div class="main-box styled-box">
        ...
        {{-- Table --}}
        @include('export.batches.table.layout', ['trashedRecords' => false])
    </div>

    {{-- Modals --}}
    <x-modals.edit-table-columns
        form-action="{{ route('settings.update-table-columns', 'export_batches_table_columns') }}"
        :columns="$allTableColumns" />
@endsection

@section('rightbar')
    @include('export.batches.partials.filter')
@endsection
