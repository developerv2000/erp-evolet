@extends('layouts.app', [
    'pageTitle' => __('Riga'),
    'pageName' => 'msd-product-batches-index',
...
@section('content')
    <div class="main-box styled-box">
        ...
        {{-- Table --}}
        @include('MSD.product-batches.table.layout', ['trashedRecords' => false])
    </div>

    {{-- Modals --}}
    <x-modals.edit-table-columns
        form-action="{{ route('settings.update-table-columns', 'MSD_product_batches_table_columns') }}"
