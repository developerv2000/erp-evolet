...
Route::middleware('auth', 'auth.session')->prefix('prd')->name('prd.')->group(function () {
    ...
    Route::prefix('/orders/invoices')->controller(PRDInvoiceController::class)->name('invoices.')->group(function () {
        Route::get('/{invoiceType}', 'index')->middleware('can:view-PRD-invoices')->name('index');
        CRUDRouteGenerator::defineDefaultRoutesOnly(['edit', 'update'], 'id', 'can:view-PRD-invoices', 'can:edit-PRD-invoices');
