...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'users' => [
            'is_in_use' => 'Пользователь :name используется, пожалуйста замените его другим пользователем и попробуйте заново.',
        ],
        ...
        'vps' => [
            'responsible_person_should_be_changed' => 'Пожалуйста, обновите ответственного при внесении изменений в продукт.',
        ],
    ],
